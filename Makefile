...
SRC     = lib/utils.cpp lib/cpdn_linux_cpu_time.cpp   \
		  api/trickle_handler.cpp   \
		  src/openifs.cpp src/cpdn_control.cpp
...
ZIP_DIR   = zip/install
INCLUDES  = -I. -I$(BOINC_DIR)/include -I$(ZIP_DIR)/include -I$(ZIP_DIR)/include/ZipLib
