...
SRC     = lib/utils.cpp  api/trickle_handler.cpp   openifs.cpp cpdn_control.cpp
...
ZIP_DIR   = zip/install
INCLUDES  = -Ilib -Iapi -I$(BOINC_DIR)/include -I$(ZIP_DIR)/include -I$(ZIP_DIR)/include/ZipLib
